 ...
 * Returns { confirmLeave, savePromptJsx } — render savePromptJsx anywhere in the page.
 */
export function useUnsavedChanges(isDirty) {
  ...
  // JSX (not a component) — avoids remount bug from defining component inside hook
  const savePromptJsx = blocker.state === 'blocked' ? (
  ...
  return { confirmLeave, savePromptJsx };
}
