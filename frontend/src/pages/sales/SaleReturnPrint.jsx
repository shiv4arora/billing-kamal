  ...
  return (
    <>
      ...
      <div className="no-print sticky top-0 bg-gray-900 text-white px-6 py-3 flex items-center gap-4">
        ...
        <button onClick={() => { const d = document.documentElement; const w = d.classList.contains('dark'); if (w) d.classList.remove('dark'); window.print(); if (w) d.classList.add('dark'); }} className="ml-auto bg-orange-600 hover:bg-orange-700 text-white text-sm px-5 py-2 rounded-lg font-medium">🖨 Print</button>
      </div>
