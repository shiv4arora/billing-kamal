    ...
    <div className="max-w-4xl space-y-4">
      ...
      <Card padding={false} className="lg:hidden">
        ...
        <div className="p-4 border-t space-y-1.5 text-sm">
          ...
          {((inv.packingCharges || 0) + (inv.shippingCharges || 0)) > 0 && <div className="flex justify-between"><span className="text-gray-500">Packing &amp; Shipping Charges</span><span>{formatCurrency((inv.packingCharges || 0) + (inv.shippingCharges || 0))}</span></div>}
