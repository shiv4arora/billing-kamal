                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                      ...
                      <span className="text-xs text-gray-400">{item.quantity} {item.unit} × {formatCurrency(item.unitPrice)}{item.gstRate ? ` + ${item.gstRate}% GST` : ''}{item.pricing?.wholesale ? ` · W:${formatCurrency(item.pricing.wholesale)}` : ''}</span>
                    </div>
                  </div>
                </div>
                {checkMode && (
